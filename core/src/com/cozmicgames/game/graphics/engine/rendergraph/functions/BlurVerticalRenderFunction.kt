...
class BlurVerticalRenderFunction(dependencyName: String, dependencyIndex: Int) : FullscreenRenderFunction("""
...
""".trimIndent(), """
    vec4 effect() {
        ...
        vec4 sum = vec4(0.0);
        sum += texture(u_texture, vec2(v_texcoord.x, v_texcoord.y - 4.0 * blurSize)) * 0.06;
